...
public class ReturnListAdminController {
	...
	@RequiresPermissions(value = { "退货单据查询" })
	public Map<String,Object> listGoodsByName(String s_returnName,String supplierId,String bReturnDate,String eReturnDate)throws Exception{
		if(s_returnName==null){
			return null;
		}
		Map<String, Object> resultMap = new HashMap<>();
		List<ReturnListGoods> purchaseListGoodsList=returnListGoodsService.listByReturnName(s_returnName,supplierId,bReturnDate,eReturnDate);
