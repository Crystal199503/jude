...
public class CustomerReturnListAdminController {
	...
	@RequiresPermissions(value = { "客户退货查询" })
	public Map<String,Object> listGoodsByName(String s_returnName,String customerId,String bCustomerReturnDate,String eCustomerReturnDate)throws Exception{
		if(s_returnName==null){
			return null;
		}
		Map<String, Object> resultMap = new HashMap<>();
		List<CustomerReturnListGoods> returnListGoodsList=customerReturnListService.listByReturnName(s_returnName,customerId,bCustomerReturnDate,eCustomerReturnDate);
