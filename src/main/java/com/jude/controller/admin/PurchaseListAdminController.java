...
public class PurchaseListAdminController {
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions(value = { "采购单据查询" })
	...
	@RequestMapping("/listGoodsByName")
	@RequiresPermissions(value = { "采购单据查询" })
	public Map<String,Object> listGoodsByName(String s_purchaseName,String supplierId,String bPurchaseDate,String ePurchaseDate)throws Exception{
		if(s_purchaseName==null){
			return null;
		}
		Map<String, Object> resultMap = new HashMap<>();
		List<PurchaseListGoods> purchaseListGoodsList=purchaseListGoodsService.listByPurchaseName(s_purchaseName,supplierId,bPurchaseDate,ePurchaseDate);
		resultMap.put("rows", purchaseListGoodsList);
		return resultMap;
	}
