...
public class SaleListAdminController {
	...
	@RequiresPermissions(value = { "销售单据查询" })
	public Map<String,Object> listGoodsByName(String s_saleName,String customerId,String bSaleDate,String eSaleDate)throws Exception{
		if(s_saleName==null){
			return null;
		}
		Map<String, Object> resultMap = new HashMap<>();
		List<SaleListGoods> purchaseListGoodsList=saleListService.listBySaleName(s_saleName,customerId,bSaleDate,eSaleDate);
	...
	public String genBillCode(String type) throws Exception {
		...
		String saleNumber = System.currentTimeMillis() + ""; // 获取当天最大的销售单号
		biilCodeStr.append(saleNumber);
