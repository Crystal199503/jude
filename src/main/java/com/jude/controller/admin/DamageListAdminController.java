...
public class DamageListAdminController {
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions(value = { "过期查询" })
	...
	@RequiresPermissions(value = {"商品过期"})
	public String genBillCode(String type)throws Exception{
		...
		String damageNumber=damageListService.getTodayMaxDamageNumber(); // 获取当天最大的过期单号
	...
	public Map<String,Object> save(DamageList damageList,String goodsJson)throws Exception{
		...
		logService.save(new Log(Log.ADD_ACTION,"添加过期单"));
